...
set nProtein [expr [$proBeads num]/3535]
$proBeads delete

;# Start and end resid numbers for M1 to M4
set M1_start_list [list 190 190 190 190 190]
set M1_end_list   [list 216 216 216 216 216]
set M2_start_list [list 218 218 218 218 218]
set M2_end_list   [list 242 242 242 242 242]
set M3_start_list [list 248 248 248 248 248]
set M3_end_list   [list 275 275 275 275 275]
set M4_start_list [list 284 284 284 284 284]
set M4_end_list   [list 1000 1000 1000 1000 1000]
